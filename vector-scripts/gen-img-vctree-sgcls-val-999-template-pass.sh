#!/bin/bash
#SBATCH --job-name=example-vctree-sgcls-val-999-pass
#SBATCH --nodes=1
...
MODEL.PRETRAINED_DETECTOR_CKPT /scratch/hdd001/home/bichengx/projects/SG-Models/vctree-sgcls_again_upload/model_0036000.pth \
DATA_STAT_DIR /scratch/hdd001/home/bichengx/projects/SG-Models/vctree-sgcls_again_upload \
GEN_IMG.EVAL True \
