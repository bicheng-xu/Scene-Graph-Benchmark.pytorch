#!/bin/bash
#SBATCH --job-name=example-motif-sgcls-val-999-pass
#SBATCH --nodes=1
...
MODEL.PRETRAINED_DETECTOR_CKPT /scratch/hdd001/home/bichengx/projects/SG-Models/motif-sgcls/model_0032000.pth \
DATA_STAT_DIR /scratch/hdd001/home/bichengx/projects/SG-Models/motif-sgcls \
GEN_IMG.EVAL True \
